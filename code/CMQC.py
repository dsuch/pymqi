...
MQCD_VERSION_8     =  8L
MQCD_VERSION_9     =  9L
MQCD_CURRENT_VERSION = 9L

MQCD_LENGTH_4 =1540L
MQCD_LENGTH_5 =1552L
MQCD_LENGTH_6 =1648L
MQCD_CURRENT_LENGTH =1648L
...
MQPA_CONTEXT =2L
MQPA_ONLY_MCA=         3L
MQPA_ALTERNATE_OR_MCA =4L

MQCDC_SENDER_CONVERSION =   1L
MQCDC_NO_SENDER_CONVERSION =0L
...
MQCXP_VERSION_3     =  3L
MQCXP_VERSION_4     =  4L
MQCXP_CURRENT_VERSION= 4L

MQXR2_PUT_WITH_DEF_ACTION = 0L
MQXR2_PUT_WITH_DEF_USERID = 1L
MQXR2_PUT_WITH_MSG_USERID = 2L
MQXR2_USE_AGENT_BUFFER    = 0L
MQXR2_USE_EXIT_BUFFER     = 4L
MQXR2_DEFAULT_CONTINUATION= 0L
MQXR2_CONTINUE_CHAIN      = 8L
MQXR2_SUPPRESS_CHAIN      = 16L

MQCF_NONE       =0x00000000L
MQCF_DIST_LISTS =0x00000001L
...
MQDXP_VERSION_1       =1L
MQDXP_CURRENT_VERSION =1L

MQXDR_OK                =0L
MQXDR_CONVERSION_FAILED =1L
...
MQWDR_VERSION_1       =1L
MQWDR_CURRENT_VERSION =1L

MQWDR_LENGTH_1       =124L
MQWDR_CURRENT_LENGTH =124L

MQQMF_REPOSITORY_Q_MGR     =0x00000002L
MQQMF_CLUSSDR_USER_DEFINED =0x00000008L
MQQMF_CLUSSDR_AUTO_DEFINED =0x00000010L
MQQMF_AVAILABLE            =0x00000020L
...
MQWQR_VERSION_1       =1L
MQWQR_CURRENT_VERSION =1L

MQWQR_LENGTH_1       =200L
MQWQR_CURRENT_LENGTH =200L

MQQF_LOCAL_Q =0x00000001L
...
MQWXP_VERSION_1       =1L
MQWXP_CURRENT_VERSION =1L
MQXT_CHANNEL_SEC_EXIT =      11L
MQXT_CHANNEL_MSG_EXIT =      12L
MQXT_CHANNEL_SEND_EXIT =     13L
MQXT_CHANNEL_RCV_EXIT  =     14L
MQXT_CHANNEL_MSG_RETRY_EXIT =15L
MQXT_CHANNEL_AUTO_DEF_EXIT  =16L
MQXT_CLUSTER_WORKLOAD_EXIT  =20L
MQXT_PUBSUB_ROUTING_EXIT    =21L
...
MQXR_INIT_SEC           = 16L
MQXR_RETRY              = 17L
MQXR_AUTO_CLUSSDR       = 18L
MQXR_AUTO_RECEIVER      = 19L
MQXR_CLWL_OPEN          = 20L
MQXR_CLWL_PUT           = 21L
MQXR_CLWL_MOVE          = 22L
MQXR_CLWL_REPOS         = 23L
MQXR_CLWL_REPOS_MOVE    = 24L
MQXR_AUTO_SVRCONN       = 27L
MQXR_AUTO_CLUSRCVR      = 28L

MQXCC_OK                    =   0L
MQXCC_SUPPRESS_FUNCTION     =   (-1L)
MQXCC_SKIP_FUNCTION         =   (-2L)
MQXCC_SEND_AND_REQUEST_SEC_MSG =(-3L)
MQXCC_SEND_SEC_MSG            = (-4L)
MQXCC_SUPPRESS_EXIT           = (-5L)
MQXCC_CLOSE_CHANNEL           = (-6L)
...
MQDCC_DEFAULT_CONVERSION   =0x00000001L
MQDCC_FILL_TARGET_BUFFER   =0x00000002L
MQDCC_SOURCE_ENC_NATIVE    =0x00000020L
MQDCC_SOURCE_ENC_NORMAL    =0x00000010L
MQDCC_SOURCE_ENC_REVERSED  =0x00000020L
MQDCC_SOURCE_ENC_UNDEFINED =0x00000000L
MQDCC_TARGET_ENC_NATIVE    =0x00000200L
MQDCC_TARGET_ENC_NORMAL    =0x00000100L
MQDCC_TARGET_ENC_REVERSED  =0x00000200L
MQDCC_TARGET_ENC_UNDEFINED =0x00000000L
MQDCC_NONE                 =0x00000000L

MQDCC_SOURCE_ENC_MASK   =0x000000f0L
MQDCC_TARGET_ENC_MASK   =0x00000f00L
MQDCC_SOURCE_ENC_FACTOR  =  16L
MQDCC_TARGET_ENC_FACTOR  =  256L
